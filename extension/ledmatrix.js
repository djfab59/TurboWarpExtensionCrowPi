    ...
    getInfo () {
      return {
        ...
        menus: {
          ...
          emojis: {
            acceptReporters: false,
            items: ['smiley', 'smiley_langue', 'smiley_square', 'smiley_square_sad', 'smiley_square_love', 'smiley_square_ho', 'smiley_square_crazy', 'smiley_square_lol', 'smiley_square_cry', 'smiley_square_langue', 'smiley_square_thug', 'sad', 'heart', 'blink']
          }
        }
      };
    }
